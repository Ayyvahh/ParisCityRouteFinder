...
//            }
    ...
    public List<GraphNode<String>> getWaypoints() {
        if(waypointsBox.getSelectionModel().getSelectedItem() == null || waypointsBox.getSelectionModel().getSelectedItem().getName().equals("MUST VISIT NONE")) {
