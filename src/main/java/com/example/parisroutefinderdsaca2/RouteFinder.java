...
public class RouteFinder implements Initializable {
    ...
    public void populateDatabase() {
        ...
        graphNodes.put("N1", new GraphNode<>("N1", false, 5,108,370));
        graphNodes.put("N2", new GraphNode<>("N2", false, 5,93,363));
        graphNodes.put("N3", new GraphNode<>("N3", false, 4,85,278));
        graphNodes.put("N4", new GraphNode<>("N4", false, 4,73,270));
        graphNodes.put("N5", new GraphNode<>("N5", false, 5,96,236));
        graphNodes.put("N6", new GraphNode<>("N6", false, 3,133,274));
        graphNodes.put("N7", new GraphNode<>("N7", false, 4,224,262));
        graphNodes.put("N8", new GraphNode<>("N8", false, 3,172,240));
        graphNodes.put("N9", new GraphNode<>("N9", false, 4,367,235));
        graphNodes.put("N10", new GraphNode<>("N10", false, 5,151,395));
        graphNodes.put("N11", new GraphNode<>("N11", false, 4,197,356));
        graphNodes.put("N12", new GraphNode<>("N12", false, 4,240,331));
        graphNodes.put("N13", new GraphNode<>("N13", false, 5,288,309));
        graphNodes.put("N14", new GraphNode<>("N14", false, 5,320,360));
        graphNodes.put("N15", new GraphNode<>("N15", false, 0,366,436));
        graphNodes.put("N16", new GraphNode<>("N16", false, 5,331,288));
        graphNodes.put("N17", new GraphNode<>("N17", false, 4,383,318));
        graphNodes.put("N18", new GraphNode<>("N18", false, 4,398,383));
        graphNodes.put("N20", new GraphNode<>("N20", false, 4,89,130));
        graphNodes.put("N21", new GraphNode<>("N21", false, 4,366,436));
        graphNodes.put("N22", new GraphNode<>("N22", false, 4,145,139));
        graphNodes.put("N24", new GraphNode<>("N24", false, 3,188,45));
        graphNodes.put("N25", new GraphNode<>("N25", false, 4,334,114));
        graphNodes.put("N27", new GraphNode<>("N27", false, 3,323,141));
        graphNodes.put("N28", new GraphNode<>("N28", false, 4,387,155));
        graphNodes.put("N29", new GraphNode<>("N29", false, 4,401,52));
        graphNodes.put("N30", new GraphNode<>("N30", false, 2,225,124));
        graphNodes.put("N31", new GraphNode<>("N31", false, 2,221,62));
        graphNodes.put("N32", new GraphNode<>("N32", false, 2,476,134));
        graphNodes.put("N33", new GraphNode<>("N33", false, 3,396,131));
        graphNodes.put("N34", new GraphNode<>("N34", false, 2,481,186));
        graphNodes.put("N35", new GraphNode<>("N35", false, 3,467,216));
        graphNodes.put("N36", new GraphNode<>("N36", false, 3,422,337));
        graphNodes.put("N37", new GraphNode<>("N37", false, 3,268,389));
        graphNodes.put("N38", new GraphNode<>("N38", false, 4,360,475));
        graphNodes.put("N39", new GraphNode<>("N39", false, 3,531,408));
        graphNodes.put("N40", new GraphNode<>("N40", false, 4,508,300));
        graphNodes.put("N41", new GraphNode<>("N41", false, 5,493,249));
        graphNodes.put("N42", new GraphNode<>("N42", false, 5,566,237));
        graphNodes.put("N43", new GraphNode<>("N43", false, 5,645,345));
        graphNodes.put("N45", new GraphNode<>("N45", false, 3,491,421));
        graphNodes.put("N46", new GraphNode<>("N46", false, 4,479,454));
        graphNodes.put("N47", new GraphNode<>("N47", false, 1,236,171));
        graphNodes.put("N48", new GraphNode<>("N48", false, 2,454,134));
        graphNodes.put("N49", new GraphNode<>("N49", false, 3,438,170));
        graphNodes.put("N50", new GraphNode<>("N50", false, 4,571,209));
        graphNodes.put("N51", new GraphNode<>("N51", false, 5,581,125));
        graphNodes.put("N52", new GraphNode<>("N52", false, 4,624,286));
        graphNodes.put("N53", new GraphNode<>("N53", false, 3,597,288));
        graphNodes.put("N54", new GraphNode<>("N54", false, 3,605,222));
        graphNodes.put("N55", new GraphNode<>("N55", false, 3,523,6));
        graphNodes.put("N56", new GraphNode<>("N56", false, 4,563,332));
        graphNodes.put("N57", new GraphNode<>("N57", false, 4,580,298));
        graphNodes.put("N58", new GraphNode<>("N58", false, 4,249,212));
        graphNodes.put("N59", new GraphNode<>("N59", false, 4,286,216));
        graphNodes.put("N60", new GraphNode<>("N60", false, 2,414,253));
        graphNodes.put("N61", new GraphNode<>("N61", false, 3,455,248));
        graphNodes.put("N62", new GraphNode<>("N62", false, 3,233,432));
        graphNodes.put("N63", new GraphNode<>("N63", false, 2,445,153));
        graphNodes.put("N64", new GraphNode<>("N64", false, 5,367,45));
        graphNodes.put("N65", new GraphNode<>("N65", false, 4,318,163));
        graphNodes.put("N66", new GraphNode<>("N66", false, 3,306,30));
        graphNodes.put("N67", new GraphNode<>("N67", false, 3,330,126));
        graphNodes.put("N68", new GraphNode<>("N68", false, 5,339,104));
        graphNodes.put("N69", new GraphNode<>("N69", false, 4,460,77));
        graphNodes.put("N70", new GraphNode<>("N70", false, 5,460,53));
        graphNodes.put("N71", new GraphNode<>("N71", false, 5,529,88));
        graphNodes.put("N72", new GraphNode<>("N72", false, 5,111,97));
